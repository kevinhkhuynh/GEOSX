                          ...
                          MeshObjectManager & msNodeManager )
{
  ...
  dofManager.addField( dofName, DofManager::Location::Node, 1, { support } );
                          ...
                          MeshObjectManager & msCellManager )
{
  ...
  dofManager.setDomain( domain );
  dofManager.addField( dofName, DofManager::Location::Elem, 1, { support } );
  dofManager.reorderByRank();
                               ...
                               Span< DofSupport const > const support )
{
  ...
  populateNodeManager( nodeLocalIndexKey, neighborRanks, *m_domain, m_support, m_nodeManager );
  populateCellManager( cellLocalIndexKey, neighborRanks, *m_domain, m_support, m_cellManager );
